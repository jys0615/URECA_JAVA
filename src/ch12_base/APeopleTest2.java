...
public class APeopleTest2 {
    public static void main(String[] args) {

        APeople2 p1 = new APeople2("강감찬");
        APeople2 p2 = new APeople2("강감찬");
 
        System.out.println(p1.equals(p2)); // true
        System.out.println(p1.toString()); // ch12_base.APeople2@15db9742 -> 클래스명@16진수 해시코드
        System.out.println(p2.toString()); // ch12_base.APeople2@6d06d69c -> 클래스명@16진수 해시코드
